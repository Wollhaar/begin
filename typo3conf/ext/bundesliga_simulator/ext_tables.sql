CREATE TABLE tx_bundesligasimulator_domain_model_club (
...
CREATE TABLE tx_bundesligasimulator_domain_model_player (
...
CREATE TABLE tx_bundesligasimulator_domain_model_coach (
